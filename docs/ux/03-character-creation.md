...
4. Optional next step: invite the member to create the **character sheet** (ticket `51-character-sheet-page`); a sheet is not required to create the character, but it is required to post in IC forums.
